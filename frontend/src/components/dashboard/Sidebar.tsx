    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-cerina-500 to-cerina-700 rounded-lg flex items-center justify-center">
            <svg
      ...
      <nav className="flex-1 p-4 space-y-1">
        {menuItems.map((item) => (
          ...
          >
            ...
            {item.badge && (
              <span className="w-2 h-2 bg-cerina-600 rounded-full animate-pulse" />
            )}
          </button>
        ))}
      </nav>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center gap-3 p-3 bg-cerina-50 rounded-lg">
            <div className="flex-shrink-0">
              <svg
                className="animate-spin h-5 w-5 text-cerina-600"
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-cerina-900">
                Generating Protocol
              </p>
              <p className="text-xs text-cerina-600 truncate">
                Agents are working...
              </p>
            </div>
          </div>
